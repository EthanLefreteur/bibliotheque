...
final class LivreController extends AbstractController
{
    ...
    #[Route('/{id}/emprunt', name: 'app_livre_emprunt', methods: ['GET','POST'])]
    public function emprunt(Request $request, Livre $livre, EntityManagerInterface $entityManager): Response
    {
        ...
        $livre = $repository->find($livre->getId());
        $user = $this->getUser();
        ...
        if ($livre->getUtilisateur() == null) {
            ...
            $entityManager->persist($livre);
            $entityManager->flush();
        } elseif ($livre->getUtilisateur()->getId() == $user->getId() or $this->isGranted('ROLE_ADMIN')) {
